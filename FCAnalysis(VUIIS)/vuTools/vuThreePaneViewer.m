...
% Labels
set(handles.tlText,'String',['Slice #: ' num2str(midSlice(3))]);
set(handles.trText,'String',['Slice #: ' num2str(midSlice(1))]);
set(handles.blText,'String',['Slice #: ' num2str(midSlice(2))]);
if (length(image.Dims)>3)
...
if (~measure)
    ...
    % Labels
    set(handles.tlText,'String',['Slice #: ' num2str(curVal)]);
...
if (~measure)
    ...
    % Labels
    set(handles.trText,'String',['Slice #: ' num2str(curVal)]);
...
if (~measure)
    ...
    % Labels
    set(handles.blText,'String',['Slice #: ' num2str(curVal)]);
